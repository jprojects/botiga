			...
			<thead>
				<tr>
					...
					<th width="1%" class="nowrap center">
		       		...
		       		<?php endif; ?>
					<th width="15%">
						<?php echo JHtml::_('grid.sort',  'COM_BOTIGA_DOCS_HEADING_NAME', 'name', $listDirn, $listOrder); ?>
					</th>
					<th width="10%">
						<?php echo JHtml::_('grid.sort',  'COM_BOTIGA_DOCS_HEADING_CATEGORY', 'category', $listDirn, $listOrder); ?>
					</th>					
				</tr>
			</thead>
			<tfoot>
