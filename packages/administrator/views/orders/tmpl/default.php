...
<form action="<?php echo JRoute::_('index.php?option=com_botiga&view=orders'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="table table-striped" class="adminList">
			<thead>
				<tr>
					...
					<th width="1%" class="nowrap center">
						<?php echo JHtml::_('grid.sort', 'Usuari', 'a.nom_empresa', $listDirn, $listOrder); ?>
					</th>		
					<th>
			...
			<tbody>
				...
				<tr class="row<?php echo $i % 2; ?>">
		            ...
		            <td>
						<?php if ($canEdit) : ?>
						<a href="<?php echo JRoute::_('index.php?option=com_botiga&view=order&id='.(int) $item->id); ?>">
						<?php echo 'WEB00'.$item->id; ?></a>
						<?php else : ?>
						<?php echo 'WEB00'.$item->id; ?>
						<?php endif; ?>
					</td>
					<td>
						<a href="index.php?option=com_botiga&view=user&layout=edit&id=<?php $item->user_id; ?>"><?php echo $item->nom_empresa; ?></a>
					</td>
					<td>
						<?php echo $item->data; ?>
					</td>
