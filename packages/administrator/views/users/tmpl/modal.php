		...
		<table class="table table-striped" class="adminList">
			...
			<tbody>
				...
				<tr class="row<?= $i % 2; ?>">
		            ...
		            <?php endif; ?>
		            <td>
						<a class="pointer" onclick="if (window.parent) window.parent.<?php echo $this->escape($function);?>('<?php echo $item->id; ?>', '<?php echo $this->escape(addslashes($item->name)); ?>');"><?= $item->nombre; ?></a>
					</td>
					<td>
