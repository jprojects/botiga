...
CREATE TABLE IF NOT EXISTS `#__botiga_comandes` (
  ...
  `sessid` varchar(150) NOT NULL DEFAULT '',
  ...
  `adreca_id` int(11) NOT NULL DEFAULT '0',
  `adreca` varchar(50) NOT NULL DEFAULT '',
  `cp` varchar(50) NOT NULL DEFAULT '',
  `poblacio` varchar(50) NOT NULL DEFAULT '',
  `pais` varchar(50) NOT NULL DEFAULT '',
  `nom_empresa` varchar(50) NOT NULL DEFAULT '',
  `mail_empresa` varchar(50) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__botiga_comandesDetall` (
  ...
  `tipus_iva` smallint(1) NOT NULL DEFAULT '1',
  `iva_percent` float(10,2) NOT NULL DEFAULT '0',
  `re_percent` float(10,2) NOT NULL DEFAULT '0.00',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `#__botiga_shipments` (
  ...
  `apply_iva` tinyint(1) NOT NULL DEFAULT '0',
  `published` tinyint(1) NOT NULL DEFAULT '0',
  `ordering` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `#__botiga_discounts` (
  ...
  `box_items` int(5) NOT NULL DEFAULT '0',
  `total` float(10,2) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `#__botiga_users` (
  ...
  `validate` smallint(1) NOT NULL DEFAULT '0',
  `metodo_pago` varchar(50) NOT NULL DEFAULT '',
  `aplicar_iva` smallint(1) NOT NULL DEFAULT '1',
  `re_equiv` smallint(1) NOT NULL DEFAULT '0',
  `pago_habitual` smallint(1) NOT NULL DEFAULT '0',
  `pago_habitual_desc` varchar(50) NOT NULL DEFAULT '',
  `dte_linia` float(10,2) NOT NULL DEFAULT '0.00',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
