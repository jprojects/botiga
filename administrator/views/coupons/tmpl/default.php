...
<form action="<?php echo JRoute::_('index.php?option=com_botiga&view=docs'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="table table-striped" class="adminList">
			<thead>
				<tr>
					...
					<th width="1%" class="nowrap center">
		       		...
		       		<?php endif; ?>
					<th>
						<?php echo JHtml::_('grid.sort',  'Título', 'a.title', $listDirn, $listOrder); ?>
					</th>
					<th>
						<?php echo JHtml::_('grid.sort',  'Categoria', 'a.category', $listDirn, $listOrder); ?>
					</th>
					<th>
						<?php echo JHtml::_('grid.sort',  'Tipo', '', $listDirn, $listOrder); ?>
					</th> 
					<th>
						<?php echo JHtml::_('grid.sort',  'Pdf', 'a.pdf_folleto', $listDirn, $listOrder); ?>
					</th>        
					<th width="10%">
			...
			<tbody>
				...
				<tr class="row<?php echo $i % 2; ?>">
		            ...
		            <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
							<?php echo JHtml::_('jgrid.published', $item->published, $i, 'docs.', $canChange, 'cb'); ?>
					</td>
		            <?php endif; ?>
					<td>
						<a href="index.php?option=com_botiga&task=doc.edit&id=<?php echo $item->id; ?>"><?php echo $item->title; ?></a>
					</td> 
					<td>
